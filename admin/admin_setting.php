    ...
    if ( ! class_exists( 'Redux_Framework_sample_config' ) ) {
        ...
        class Redux_Framework_sample_config {
            ...
            public function setSections() {
                ...
                $this->sections[] = array(
                    'title'  => __( 'Ajustes generales', 'redux-framework-demo' ),
                    ...
                    'fields' => array(
                        array(
                            ...
                            'compiler' => 'true',
                            'desc'     => __( 'Favor subir .....', 'redux-framework-demo' ),
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'type'     => 'text',
                            'validate' => '',
                            'title'    => __( 'Encabezado', 'redux-framework-demo' ),
                            'desc'     => __( '' ),
                        ...
                        array(
                            ...
                            'type'     => 'textarea',
                            'validate' => '',
                            'title'    => __( 'Descripcion', 'redux-framework-demo' ),
                            'desc'     => __( '' ),
                            'default'  => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras congue, dui in malesuada tincidunt.',
                        ),
                        ...
                        array(
                            ...
                            'compiler' => 'true',
                            'desc'     => __( 'Favor subir una .....', 'redux-framework-demo' ),
                        ...
                        array(
                            ...
                            'type'     => 'text',
                            'validate' => '',
                            'title'    => __( 'Texto del boton', 'redux-framework-demo' ),
                            'desc'     => __( '' ),
                            'default'  => 'Iniciar',
                        ),
                    ...
                    //slider 2
                        ...
                        array(
                            ...
                            'title'    => __( 'Imagen', 'redux-framework-demo' ),
                            'compiler' => 'true',
                            'desc'     => __( 'Subir una imagen .....', 'redux-framework-demo' ),
            ...
            //Sesion 2
                ...
                'title'  => __( 'Sesion 2', 'redux-framework-demo' ),
                'fields' => array(
                       
                       array(
                            'id' => 'section_feature_info',
                            'type' => 'info',
                            'title' => __('Añadirle informacion <a href="' . site_url() . '/wp-admin/post-new.php?post_type=feature">aqui</a> ', 'redux-framework-demo'),
                            'style' => 'warning'
                        ),
                        ...
                        array(
                            ...
                            'type' => 'switch',
                            'title' => __('Mostrar sesion', 'redux-framework-demo'),
                        ...
                        array(
                            ...
                            'type' => 'text',
                            'title' => __('Titulo del menu', 'redux-framework-demo'),
                            'default' => "Feature",
                        ),
                        array(
                            'id' => "section_feature_title",
                            'type' => 'text',
                            'title' => __('Titulo Sesion', 'redux-framework-demo'),
                            'default' => "Our Front End Feature",
                        ),
                        array(
                            'id' => "section_feature_subtitle",
                            'type' => 'textarea',
                            'title' => __('Subtitulo de la sesion', 'redux-framework-demo'),
                        ...
                        array(
                            ...
                            'type' => 'text',
                            'title' => __('Opciones a mostrar?', 'redux-framework-demo'),
                            'default' => "6",
                        ),
            ...
            $this->sections[] = array(
                ...
                'title'  => __( 'Sesion 3', 'redux-framework-demo' ),
                'fields' => array(
                       ...
                       array(
                            ...
                            'type'     => 'media',
                            'url'      => true,
                            'title'    => __( 'Imagen de la sesion', 'redux-framework-demo' ),
                            'compiler' => 'true',
                            'desc'     => __( 'Subir una imagen .....', 'redux-framework-demo' ),
                            'default'  => array( 'url' => get_stylesheet_directory_uri().'/images/slider-3.jpg'),
                        ),
                        ...
                        array(
                            ...
                            'type' => 'text',
                            'title' => __('Titulo menu', 'redux-framework-demo'),
                            'default' => "About Us",
                        ),
                        array(
                        ...
                        array(
                            ...
                            'type' => 'textarea',
                            'title' => __('Subtitulo sesion', 'redux-framework-demo'),
                        ...
                        array(
                            ...
                            'type'     => 'media',
                            'url'      => true,
                            'title'    => __( 'Bg', 'redux-framework-demo' ),
                            'compiler' => 'true',
                            'desc'     => __( 'Subir imagen .....', 'redux-framework-demo' ),
            ...
            // Sesion 4
                ...
                $this->sections[] = array(
                    'title'  => __( 'Sesion 4', 'redux-framework-demo' ),
                    'desc'   => __( '', 'redux-framework-demo' ),
                    'icon'   => 'el-icon-tasks',
                    // 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
                    'fields' => array(
                        ...
                        array(
                            ...
                            'type' => 'info',
                            'title' => __('Añadirle informacion <a href="' . site_url() . '/wp-admin/post-new.php?post_type=testimonial">aqui</a> ', 'redux-framework-demo'),
                            'style' => 'warning'
                        ),
                ...
                $this->sections[] = array(
                    'title'  => __( 'Sesion 5', 'redux-framework-demo' ),
                    'desc'   => __( '', 'redux-framework-demo' ),
                    'icon'   => 'el-icon-user',
                    // 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
                    'fields' => array(
                        ...
                        array(
                            ...
                            'type' => 'info',
                            'title' => __('Añadirle informacion <a href="' . site_url() . '/wp-admin/post-new.php?post_type=team">aqui</a> ', 'redux-framework-demo'),
                            'style' => 'warning'
                        ),
            ...
            // Portafolio
                ...
                $this->sections[] = array(
                    'title'  => __( 'Portafolio', 'redux-framework-demo' ),
                    'desc'   => __( '', 'redux-framework-demo' ),
                    'icon'   => 'el-icon-fork',
                    'fields' => array(
                        ...
                        array(
                            ...
                            'type' => 'info',
                            'title' => __('Añadirle informacion <a href="' . site_url() . '/wp-admin/post-new.php?post_type=portfolio">aqui</a> ', 'redux-framework-demo'),
                            'style' => 'warning'
                        ),
                        ...
                        array(
                            ...
                            'type' => 'text',
                            'title' => __('Nombre menu', 'redux-framework-demo'),
                            'default' => "Portafolio",
                        ),
                ...
                $this->sections[] = array(
                    'title'  => __( 'Contacto', 'redux-framework-demo' ),
                    'desc'   => __( '', 'redux-framework-demo' ),
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'type' => 'text',
                            'title' => __('Direccion', 'redux-framework-demo'),
                        ...
                        array(
                            ...
                            'type' => 'text',
                            'title' => __('Telefono', 'redux-framework-demo'),
                            'default' => "1223456789",
                        ),
                        ...
                        array(
                            ...
                            'type' => 'textarea',
                            'title' => __('Embeb Google Maps', 'redux-framework-demo'),
                        ...
                        array(
                            ...
                            'type' => 'editor',
                            'title' => __('Area Contact Form', 'redux-framework-demo'),
                            'default' => "",
                        ),
            ...
            // Pie de pagina
                ...
                $this->sections[] = array(
                    'title'  => __( 'Pie de pagina', 'redux-framework-demo' ),
                    'desc'   => __( '', 'redux-framework-demo' ),
                    'icon'   => 'el-icon-edit',
                    // 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
                    'fields' => array(
            ...
            public function setArguments() {
                ...
                $this->args = array(
                    ...
                    'display_name'         => 'Opciones del sitio',
                    ...
                    'menu_title'           => __( 'Opciones del sitio', 'redux-framework-demo' ),
                    'page_title'           => __( 'Opciones del sitio', 'redux-framework-demo' ),
